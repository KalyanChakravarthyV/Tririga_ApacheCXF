 ...
 *         &lt;element name="sections" type="{http://dto.ws.tririga.com}ArrayOfIntegrationSection-1-"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class IntegrationRecord {
    ...
    @XmlElement(required = true)
    protected ArrayOfIntegrationSection1 sections;
     ...
     * @return
     *     possible object is
     *     {@link ArrayOfIntegrationSection1 }
     *     
     */
    public ArrayOfIntegrationSection1 getSections() {
        return sections;
    }
     ...
     *     
     */
    public void setSections(ArrayOfIntegrationSection1 value) {
        this.sections = value;
    }
