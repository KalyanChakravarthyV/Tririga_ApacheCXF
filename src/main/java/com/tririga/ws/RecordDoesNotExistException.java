...
public class RecordDoesNotExistException extends java.lang.Exception {
    ...
    public RecordDoesNotExistException(String message, java.lang.Throwable cause) {
        super(message, cause);
    }
    ...
    public RecordDoesNotExistException(String message, com.tririga.ws.errors.RecordDoesNotExistException recordDoesNotExistException, java.lang.Throwable cause) {
        super(message, cause);
        this.faultInfo = recordDoesNotExistException;
    }
