...
public class InvalidDocumentTypeException extends java.lang.Exception {
    ...
    public InvalidDocumentTypeException(String message, java.lang.Throwable cause) {
        super(message, cause);
    }
    ...
    public InvalidDocumentTypeException(String message, com.tririga.ws.dto.content.InvalidDocumentTypeException invalidDocumentTypeException, java.lang.Throwable cause) {
        super(message, cause);
        this.faultInfo = invalidDocumentTypeException;
    }
