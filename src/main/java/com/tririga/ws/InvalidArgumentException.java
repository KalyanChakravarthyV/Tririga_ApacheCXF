...
public class InvalidArgumentException extends java.lang.Exception {
    ...
    public InvalidArgumentException(String message, com.tririga.ws.errors.InvalidArgumentException invalidArgumentException, java.lang.Throwable cause) {
        super(message, cause);
        this.faultInfo = invalidArgumentException;
    }
