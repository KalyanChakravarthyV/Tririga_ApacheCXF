...
public class ModuleDoesNotExistException extends java.lang.Exception {
    ...
    public ModuleDoesNotExistException(String message, java.lang.Throwable cause) {
        super(message, cause);
    }
    ...
    public ModuleDoesNotExistException(String message, com.tririga.ws.errors.ModuleDoesNotExistException moduleDoesNotExistException, java.lang.Throwable cause) {
        super(message, cause);
        this.faultInfo = moduleDoesNotExistException;
    }
