...
public class ProjectDoesNotExistException extends java.lang.Exception {
    ...
    public ProjectDoesNotExistException(String message, java.lang.Throwable cause) {
        super(message, cause);
    }
    ...
    public ProjectDoesNotExistException(String message, com.tririga.ws.errors.ProjectDoesNotExistException projectDoesNotExistException, java.lang.Throwable cause) {
        super(message, cause);
        this.faultInfo = projectDoesNotExistException;
    }
